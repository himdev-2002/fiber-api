...
type PostUserSysParamsRequest struct {
	CatID    uint64  `json:"cat_id" form:"cat_id" validate:"required,min=0,number"`
	SubCatID uint64  `json:"sub_cat_id" form:"_sub_cat_id,omitempty" validate:"min=0,number,omitempty"`
	...
	Num1     float64 `json:"_num_1" validate:"min=number,omitempty"`
	Num2     float64 `json:"_num_2" validate:"min=number,omitempty"`
	Num3     float64 `json:"_num_3" validate:"min=number,omitempty"`
